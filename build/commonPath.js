...
var rootPath = path.resolve(__dirname, '..'),             // 项目根目录
    ...
    entry = path.join(src, 'js/app.js'),                  // 主入口文件
    ...
    daoPath = path.join(src, "js/dao"),                   // dao文件目录
    dataPath = path.join(src, "data"),                    // 测试数据文件目录
    utilsPath = path.join(src, "js/utils"),               // 工具类文件目录
    constsPath = path.join(src, "js/consts"),             // 常量类文件目录
    actionsPath = path.join(src, "js/actions"),           // actions文件目录
    servicesPath = path.join(src, "js/services"),         // services文件目录
    componentsPath = path.join(src, "js/components");     // components文件目录
